inherited frmPessoa: TfrmPessoa
  ...
  inherited pgCadastro: TPageControl
    ...
    inherited tsConsulta: TTabSheet
      ...
      inherited Panel1: TPanel
        ...
        object lblPesquisaDataNascimento: TLabel
          Left = 16
          Top = 43
          Width = 107
          Height = 15
        ...
        object dtpkPesquisaDataNascimento: TDateTimePicker
          Left = 16
          Top = 60
          Width = 186
          Height = 23
      ...
      inherited Panel2: TPanel
        ...
        inherited grdConsulta: TDBCtrlGrid
          ...
          Width = 867
          Height = 418
          DataSource = dsBS_PESSOA
          PanelBorder = gbNone
          PanelHeight = 41
          PanelWidth = 850
          SelectedColor = clLightblue
          StyleName = ''
          ExplicitTop = 39
          ExplicitWidth = 867
          ExplicitHeight = 425
  ...
  object dsBS_PESSOA: TDataSource
    DataSet = DataModule1.cdsBS_PESSOA
    Left = 772
    Top = 306
  end
end
